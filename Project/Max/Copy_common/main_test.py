...
feature_image_2 = cv2.imread('media/thymio_circle_green.png')
feature_image_1 = cv2.imread('media/thymio_circle_blue.png')
...
feature_color_2 = [8, 72, 47]
feature_color_1 = [39, 52, 104]
